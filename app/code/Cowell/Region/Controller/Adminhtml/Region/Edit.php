...
class Edit extends \Cowell\Region\Controller\Adminhtml\Region
{
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('cowell_region_region', $model);
        ...
        $resultPage->getConfig()->getTitle()->prepend($model->getId() ? __('Edit Region %1', $model->getId()) : __('New Region'));
        return $resultPage;
    }
}

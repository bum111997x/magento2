...
namespace CoWell\BasicTraining\Model\Import;
...
class Courses extends AbstractEntity
{
    ...
    public function validateRow(array $rowData, $rowNum): bool
    {
        ...
        if (!$dob) {
            $this->addRowError('DobIsRequired', $rowNum);
        }
    ...
    private function initMessageTemplates()
    {
        ...
        $this->addMessageTemplate(
            'GenderIsRequired',
            __('Gender should be greater than 0.')
        );
        $this->addMessageTemplate(
            'DobIsRequired',
            __('Dob should be greater than 0.')
        );
        $this->addMessageTemplate(
            'AddressIsRequired',
            __('Address should be greater than 0.')
        );
        $this->addMessageTemplate(
            'ImgIsRequired',
            __('Img should be greater than 0.')
        );
    }
}
